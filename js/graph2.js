...
function DrawChartNeighborhoods(chartSelector, legendSelector) {
    d3.csv("https://raw.githubusercontent.com/a-distante1999/a-distante1999.github.io/main/csv/geo_data_trees_neighborhoods.csv").then(function (data) {
        ...
        svg.append("g")
            ...
            .on("mouseover", function (event, d) { // What happens when user hover a bar
                ...
                tooltip
                    .html("Tree: " + tree + "<br>" + "Abundance: " + subgroupValue)
                    .style("display", "block");
...
$(window).resize(function () {
    if (currentWidth !== window.innerWidth) {
        ...
        DrawChartNeighborhoods('.chart', '.legend');
    }
});